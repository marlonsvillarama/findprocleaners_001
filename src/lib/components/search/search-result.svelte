<script>
    ...
    let featuredStyles = data.is_featured === true ?
        ...
        'border-b-gray-300 border-1 shadow-sm hover:bg-white hover:border-1 hover:shadow-md duration-[150ms] ease-in-out';
</script>
...
<div class="w-full grid grid-cols-[1fr_250px] gap-4 border-b-1 rounded-md py-2 px-6 py-4 {featuredStyles}">
    <div class="details grid gap-4">
        <div class="grid gap-1 items-center justify-between">
